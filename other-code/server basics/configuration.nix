...
#  ];
  ...
  services.github-runners.miniserver24 = {
    enable = true;
    url = "https://github.com/markus-barta/pixoo-daemon";
    tokenFile = "/home/mba/secrets/.github-runner-token";
    name = "miniserver24-runner";
  };

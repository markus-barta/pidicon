...
class StateStore {
   ...
   * @param {number} [dependencies.debounceMs] - Debounce interval for persistence (default: 2000ms, reduced from 10000ms for UI-508)
   */
  constructor({ logger, persistPath = null, debounceMs = 2000 } = {}) {
    ...
    // Reduced from 10s to 2s for faster persistence (UI-508)

 ...
 * @license MIT
 * @stability Production-grade with comprehensive state management
 */
...
const SceneUtils = {
  ...
  getConfig(payload, defaults = {}) {
    return {
      interval: payload?.interval ?? defaults.interval ?? null,
      frames: payload?.frames ?? defaults.frames ?? null,
      ...defaults,
    };
  },

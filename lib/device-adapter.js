...
const DRIVER_DEFAULT = (
  ...
  process.env.PIDICO_DEFAULT_DRIVER || // Legacy v3.0 (deprecated, use PIDICON)
...
if (useOverride) {
  ...
  TARGETS_RAW =
    ...
    process.env.PIDICO_DEVICE_TARGETS || // Legacy v3.0 (deprecated, use PIDICON)
  ...
  } else if (process.env.PIDICO_DEVICE_TARGETS) {
    logger.warn(
      '⚠️  PIDICO_DEVICE_TARGETS is deprecated, use PIDICON_DEVICE_TARGETS',
    );

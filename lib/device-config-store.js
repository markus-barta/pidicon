...
class DeviceConfigStore {
  constructor(configPath = null) {
    ...
    this.settings = {
      ...
      mqttPassword: process.env.PIDICON_MQTT_PASSWORD || '',
    };
    this.loaded = false;
    ...
    try {
      ...
      if (json.settings) {
        this.settings = {
          ...
          mqttPassword:
            json.settings.mqttPassword || this.settings.mqttPassword || '',
        };
      }
  ...
  async updateSettings(newSettings) {
    ...
    this.settings.mqttPassword = this.settings.mqttPassword || '';
    await this._ensureDirectories();
    await this.save();
